...
class Component implements Component_Interface, Templating_Component_Interface {
	 ...
	 */
	public function palette_option( $subkey ) {
		...
		$active = apply_filters( 'kadence_active_palette', ( self::$palette && is_array( self::$palette ) && isset( self::$palette['active'] ) && ! empty( self::$palette['active'] ) ? self::$palette['active'] : 'palette' ) );
		$value = '';
