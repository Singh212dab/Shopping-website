...
class Component implements Component_Interface {
	...
	public function generate_events_css() {
		...
		$css->add_property( 'background', $css->render_color( kadence()->sub_option( 'tribe_events_title_overlay_color', 'color' ) ) );
		...
		$css->set_selector( '.tribe_events-hero-section .entry-header' );
