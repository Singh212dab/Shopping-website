...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function generate_base_css() {
		...
		$css->add_property( '--global-palette-btn-bg', $this->render_color( kadence()->sub_option( 'buttons_background', 'color' ) ) );
		$css->add_property( '--global-palette-btn-bg-hover', $this->render_color( kadence()->sub_option( 'buttons_background', 'hover' ) ) );
		...
		if ( kadence()->option( 'custom_logo' ) || is_customize_preview() ) {
			...
			foreach ( array( 'desktop', 'tablet', 'mobile' ) as $device ) {
				if ( isset( $logo_width['size'] ) && isset( $logo_width['size'][ $device ] ) && ! empty( $logo_width['size'][ $device ] ) ) {
					...
					if ( 'desktop' !== $device ) {
						if ( 'tablet' === $device ){
							$css->start_media_query( ( kadence()->sub_option( 'header_mobile_switch', 'size' ) ? '(max-width: ' . kadence()->sub_option( 'header_mobile_switch', 'size' ) . 'px)' : $media_query[ $device ] ) );
						} else {
		...
		$css->start_media_query( ( kadence()->sub_option( 'header_mobile_switch', 'size' ) ? '(max-width: ' . kadence()->sub_option( 'header_mobile_switch', 'size' ) . 'px)' : $media_query['tablet'] ) );
		$css->set_selector( '.site-branding' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'brand_typography_color', 'hover' ) ) );
		$css->set_selector( 'body.home .site-branding .site-title' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'brand_typography_color', 'active' ) ) );
		...
		$css->stop_media_query();
		// Header.
		$css->set_selector( '#masthead, #masthead .kadence-sticky-header.item-is-fixed:not(.item-at-start):not(.site-header-row-container), #masthead .kadence-sticky-header.item-is-fixed:not(.item-at-start) > .site-header-row-container-inner' );
		...
		$css->add_property( 'border-top', $css->render_border( kadence()->sub_option( 'header_main_top_border', 'tablet' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( kadence()->sub_option( 'header_main_bottom_border', 'tablet' ) ) );
		$css->set_selector( '.site-main-header-inner-wrap' );
		...
		$css->add_property( 'border-top', $css->render_border( kadence()->sub_option( 'header_main_top_border', 'mobile' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( kadence()->sub_option( 'header_main_bottom_border', 'mobile' ) ) );
		$css->set_selector( '.site-main-header-inner-wrap' );
		...
		$css->add_property( 'border-top', $css->render_border( kadence()->sub_option( 'header_top_top_border', 'tablet' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( kadence()->sub_option( 'header_top_bottom_border', 'tablet' ) ) );
		$css->set_selector( '.site-top-header-inner-wrap' );
		...
		$css->add_property( 'border-top', $css->render_border( kadence()->sub_option( 'header_top_top_border', 'mobile' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( kadence()->sub_option( 'header_top_bottom_border', 'mobile' ) ) );
		$css->set_selector( '.site-top-header-inner-wrap' );
		...
		$css->add_property( 'border-top', $css->render_border( kadence()->sub_option( 'header_bottom_top_border', 'tablet' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( kadence()->sub_option( 'header_bottom_bottom_border', 'tablet' ) ) );
		$css->set_selector( '.site-bottom-header-inner-wrap' );
		...
		$css->add_property( 'border-top', $css->render_border( kadence()->sub_option( 'header_bottom_top_border', 'mobile' ) ) );
		$css->add_property( 'border-bottom', $css->render_border( kadence()->sub_option( 'header_bottom_bottom_border', 'mobile' ) ) );
		$css->set_selector( '.site-bottom-header-inner-wrap' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_site_title_color', 'color' ) ) );
		$css->set_selector( '#masthead .kadence-sticky-header.item-is-fixed:not(.item-at-start) .header-menu-container > ul > li > a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_navigation_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_navigation_background', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_navigation_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_navigation_background', 'hover' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_navigation_color', 'active' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_navigation_background', 'active' ) ) );
		// Sticky Button.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_button_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_button_color', 'background' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_sticky_button_color', 'border' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_button_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_button_color', 'backgroundHover' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_sticky_button_color', 'borderHover' ) ) );
		// Sticky Social.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_social_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_social_color', 'background' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_sticky_social_color', 'border' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_social_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_social_color', 'backgroundHover' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_sticky_social_color', 'borderHover' ) ) );
		// Sticky cart.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_cart_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_cart_color', 'background' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_cart_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_cart_color', 'backgroundHover' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_cart_total_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_cart_total_color', 'background' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_cart_total_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_sticky_cart_total_color', 'backgroundHover' ) ) );
		// Sticky HTML.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_html_color', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_html_color', 'link' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_sticky_html_color', 'hover' ) ) );
		// Sticky Header Logo.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_site_title_color', 'color' ) ) );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_navigation_background', 'active' ) ) );
		// Transparent Button.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_button_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_button_color', 'background' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'transparent_header_button_color', 'border' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_button_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_button_color', 'backgroundHover' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'transparent_header_button_color', 'borderHover' ) ) );
		// Transparent Social.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_social_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_social_color', 'background' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'transparent_header_social_color', 'border' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_social_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_social_color', 'backgroundHover' ) ) );
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'transparent_header_social_color', 'borderHover' ) ) );
		// Transparent cart.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_cart_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_cart_color', 'background' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_cart_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_cart_color', 'backgroundHover' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_cart_total_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_cart_total_color', 'background' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_cart_total_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'transparent_header_cart_total_color', 'backgroundHover' ) ) );
		// Transparent HTML.
		$css->set_selector( '.transparent-header #main-header .header-html, .mobile-transparent-header .mobile-html' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_html_color', 'color' ) ) );
		$css->set_selector( '.transparent-header #main-header .header-html a, .mobile-transparent-header .mobile-html a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_html_color', 'link' ) ) );
		$css->set_selector( '.transparent-header #main-header .header-html a:hover, .mobile-transparent-header .mobile-html a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'transparent_header_html_color', 'hover' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'secondary_navigation_color', 'active' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'secondary_navigation_background', 'active' ) ) );
		// Dropdown.
		$css->set_selector( '.header-navigation .header-menu-container ul ul' );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'dropdown_navigation_background', 'color' ) ) );
		...
		$css->set_selector( '.header-navigation .header-menu-container ul ul li, .header-menu-container ul.menu > li.kadence-menu-mega-enabled > ul > li > a' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'dropdown_navigation_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'dropdown_navigation_background', 'hover' ) ) );
		$css->set_selector( '.header-navigation .header-menu-container ul ul li.current-menu-item > a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'dropdown_navigation_color', 'active' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'dropdown_navigation_background', 'active' ) ) );
		// Mobile Toggle.
		$css->set_selector( '.mobile-toggle-open-container .menu-toggle-open' );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'mobile_trigger_background', 'color' ) ) );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_trigger_color', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_trigger_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'mobile_trigger_background', 'hover' ) ) );
		// Mobile Menu.
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'mobile_navigation_background', 'color' ) ) );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_navigation_color', 'color' ) ) );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'mobile_navigation_background', 'hover' ) ) );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_navigation_color', 'hover' ) ) );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'mobile_navigation_background', 'active' ) ) );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_navigation_color', 'active' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_popup_close_color', 'color' ) ) );
		$css->set_selector( '#mobile-drawer .drawer-header .drawer-toggle:hover, #mobile-drawer .drawer-header .drawer-toggle:focus:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_popup_close_color', 'hover' ) ) );
		// Header Button.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_button_color', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_html_link_color', 'color' ) ) );
		$css->set_selector( '.header-html a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_html_link_color', 'hover' ) ) );
		// Woo Header.
		if ( class_exists( 'woocommerce' ) ) {
			...
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_cart_total_background', 'hover' ) ) );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_cart_total_color', 'hover' ) ) );
			...
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_mobile_cart_background', 'color' ) ) );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_mobile_cart_color', 'color' ) ) );
			...
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_mobile_cart_total_background', 'color' ) ) );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_mobile_cart_total_color', 'color' ) ) );
			$css->set_selector( '.header-mobile-cart-wrap .header-cart-inner-wrap .header-cart-button:hover' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_mobile_cart_background', 'hover' ) ) );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_mobile_cart_color', 'hover' ) ) );
			$css->set_selector( '.header-mobile-cart-wrap .header-cart-button:hover .header-cart-total' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_mobile_cart_total_background', 'hover' ) ) );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_mobile_cart_total_color', 'hover' ) ) );
		...
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_social_border_colors', 'color' ) ) );
		...
		if ( ! in_array( kadence()->option( 'header_social_brand' ), array( 'always', 'onhover' ), true ) ) {
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_social_color', 'hover' ) ) );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_social_background', 'hover' ) ) );
		}
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_social_border_colors', 'hover' ) ) );
		...
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_mobile_social_border_colors', 'color' ) ) );
		...
		if ( ! in_array( kadence()->option( 'header_mobile_social_brand' ), array( 'always', 'onhover' ), true ) ) {
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_mobile_social_color', 'hover' ) ) );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_mobile_social_background', 'hover' ) ) );
		}
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'header_mobile_social_border_colors', 'hover' ) ) );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_search_background', 'color' ) ) );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_search_color', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_search_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'header_search_background', 'hover' ) ) );
		// Search Modal.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_search_modal_color', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'header_search_modal_color', 'hover' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_button_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'mobile_button_background', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_html_link_color', 'color' ) ) );
		$css->set_selector( '.mobile-html a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'mobile_html_link_color', 'hover' ) ) );
		// Footer.
		...
		$css->set_selector( '.site-footer .site-middle-footer-wrap .site-footer-row-container-inner a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_middle_link_colors', 'color' ) ) );
		$css->set_selector( '.site-footer .site-middle-footer-wrap .site-footer-row-container-inner a:hover' );
		...
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_middle_column_spacing' ), 'desktop' ) );
		...
		$css->set_selector( '.site-middle-footer-inner-wrap .widget' );
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_middle_column_spacing' ), 'tablet' ) );
		$css->set_selector( '.site-middle-footer-inner-wrap .site-footer-section:not(:last-child):after' );
		...
		$css->set_selector( '.site-middle-footer-inner-wrap .widget' );
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_middle_column_spacing' ), 'mobile' ) );
		$css->set_selector( '.site-middle-footer-inner-wrap .site-footer-section:not(:last-child):after' );
		...
		$css->set_selector( '.site-footer .site-top-footer-wrap .site-footer-row-container-inner a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_top_link_colors', 'color' ) ) );
		$css->set_selector( '.site-footer .site-top-footer-wrap .site-footer-row-container-inner a:hover' );
		...
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_top_column_spacing' ), 'desktop' ) );
		...
		$css->set_selector( '.site-top-footer-inner-wrap .widget' );
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_top_column_spacing' ), 'tablet' ) );
		$css->set_selector( '.site-top-footer-inner-wrap .site-footer-section:not(:last-child):after' );
		...
		$css->set_selector( '.site-top-footer-inner-wrap .widget' );
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_top_column_spacing' ), 'mobile' ) );
		$css->set_selector( '.site-top-footer-inner-wrap .site-footer-section:not(:last-child):after' );
		...
		$css->set_selector( '.site-footer .site-bottom-footer-wrap .site-footer-row-container-inner a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_bottom_link_colors', 'color' ) ) );
		$css->set_selector( '.site-footer .site-bottom-footer-wrap .site-footer-row-container-inner a:hover' );
		...
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_bottom_column_spacing' ), 'desktop' ) );
		...
		$css->set_selector( '.site-bottom-footer-inner-wrap .widget' );
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_bottom_column_spacing' ), 'tablet' ) );
		$css->set_selector( '.site-bottom-footer-inner-wrap .site-footer-section:not(:last-child):after' );
		...
		$css->set_selector( '.site-bottom-footer-inner-wrap .widget' );
		$css->add_property( 'margin-bottom', $this->render_range( kadence()->option( 'footer_bottom_column_spacing' ), 'mobile' ) );
		$css->set_selector( '.site-bottom-footer-inner-wrap .site-footer-section:not(:last-child):after' );
		...
		$css->set_selector( '.site-footer .site-footer-wrap .footer-social-wrap .social-button' );
		...
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'footer_social_border_colors', 'color' ) ) );
		$css->add_property( 'border-radius', $this->render_size( kadence()->sub_option( 'footer_social_border_radius' ) ) );
		$css->set_selector( '.site-footer .site-footer-wrap .footer-social-wrap .footer-social-inner-wrap .social-button:hover' );
		if ( ! in_array( kadence()->option( 'footer_social_brand' ), array( 'always', 'onhover' ), true ) ) {
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_social_color', 'hover' ) ) );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'footer_social_background', 'hover' ) ) );
		}
		$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'footer_social_border_colors', 'hover' ) ) );
		...
		if ( kadence()->option( 'scroll_up' ) ) {
			...
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'scroll_up_background', 'color' ) ) );
			$css->add_property( 'border-color', $this->render_color( kadence()->sub_option( 'scroll_up_border_colors', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_navigation_color', 'color' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'footer_navigation_background', 'color' ) ) );
		$css->set_selector( '#colophon .footer-navigation .footer-menu-container > ul li a' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_navigation_color', 'hover' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'footer_navigation_background', 'hover' ) ) );
		$css->set_selector( '#colophon .footer-navigation .footer-menu-container > ul li.current-menu-item > a' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'footer_navigation_color', 'active' ) ) );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'footer_navigation_background', 'active' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'page_title_meta_color', 'color' ) ) );
		$css->set_selector( '.page-title .entry-meta a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'page_title_meta_color', 'hover' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.page-title .entry-meta' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'page_title_breadcrumb_color', 'color' ) ) );
		$css->set_selector( '.page-title .kadence-breadcrumbs a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'page_title_breadcrumb_color', 'hover' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.page-title .kadence-breadcrumbs' );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'page_title_overlay_color', 'color' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.page-hero-section .entry-hero-container-inner' );
		...
		if ( is_singular( 'post' ) ) {
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_category_color', 'color' ) ) );
			$css->set_selector( '.post-title .entry-taxonomies a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_category_color', 'hover' ) ) );
			$css->set_selector( '.post-title .entry-taxonomies .category-style-pill a' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'post_title_category_color', 'color' ) ) );
			$css->set_selector( '.post-title .entry-taxonomies .category-style-pill a:hover' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'post_title_category_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_meta_color', 'color' ) ) );
			$css->set_selector( '.post-title .entry-meta a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_meta_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.post-title .entry-meta' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.post-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.post-title .kadence-breadcrumbs' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_excerpt_color', 'color' ) ) );
			$css->set_selector( '.post-title .title-entry-excerpt a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_title_excerpt_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.post-title .title-entry-excerpt' );
			...
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'post_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.post-hero-section .entry-hero-container-inner' );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'post_archive_title_overlay_color', 'color' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.post-archive-hero-section .entry-hero-container-inner' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_title_breadcrumb_color', 'hover' ) ) );
		$css->set_selector( '.post-archive-title .archive-description' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_title_description_color', 'color' ) ) );
		$css->set_selector( '.post-archive-title .archive-description a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_title_description_color', 'hover' ) ) );
		// Archive Backgrounds.
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_item_category_color', 'color' ) ) );
		$css->set_selector( '.loop-entry.type-post .entry-taxonomies .category-style-pill a' );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'post_archive_item_category_color', 'color' ) ) );
		$css->set_selector( '.loop-entry.type-post .entry-taxonomies a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_item_category_color', 'hover' ) ) );
		$css->set_selector( '.loop-entry.type-post .entry-taxonomies .category-style-pill a:hover' );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'post_archive_item_category_color', 'hover' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.loop-entry.type-post .entry-taxonomies' );
		...
		$css->set_selector( '.loop-entry.type-post .entry-meta' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_item_meta_color', 'color' ) ) );
		$css->set_selector( '.loop-entry.type-post .entry-meta a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'post_archive_item_meta_color', 'hover' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.loop-entry.type-post .entry-meta' );
		...
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'search_archive_title_overlay_color', 'color' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.search-archive-hero-section .entry-hero-container-inner' );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'search_archive_title_color', 'color' ) ) );
		...
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'search_archive_item_category_color', 'color' ) ) );
		$css->set_selector( '.loop-entry .entry-taxonomies .category-style-pill a' );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'search_archive_item_category_color', 'color' ) ) );
		$css->set_selector( '.search-results .loop-entry .entry-taxonomies a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'search_archive_item_category_color', 'hover' ) ) );
		$css->set_selector( '.loop-entry .entry-taxonomies .category-style-pill a:hover' );
		$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'search_archive_item_category_color', 'hover' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.search-results .loop-entry .entry-taxonomies' );
		...
		$css->set_selector( '.search-results .loop-entry .entry-meta' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'search_archive_item_meta_color', 'color' ) ) );
		$css->set_selector( '.search-results .loop-entry .entry-meta a:hover' );
		$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'search_archive_item_meta_color', 'hover' ) ) );
		$css->start_media_query( $media_query['tablet'] );
		$css->set_selector( '.search-results .loop-entry .entry-meta' );
		...
		if ( class_exists( 'woocommerce' ) ) {
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.woocommerce-demo-store .woocommerce-store-notice a, .woocommerce-demo-store .woocommerce-store-notice' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_title_breadcrumb_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.woocommerce-demo-store .woocommerce-store-notice a, .woocommerce-demo-store .woocommerce-store-notice' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_title_breadcrumb_font' ), 'mobile' ) );
			$css->stop_media_query();
			// Above Product Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'product_title_height' ), 'desktop' ) );
			$css->set_selector( '.product-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'product_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.product-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'product_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.product-hero-section .entry-hero-container-inner' );
			...
			$css->set_selector( '.entry-hero.product-hero-section .entry-header' );
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'product_title_height' ), 'mobile' ) );
			$css->stop_media_query();
			// Product Breadcrumbs.
			$css->set_selector( '.product-title .kadence-breadcrumbs' );
			$css->render_font( kadence()->option( 'product_title_breadcrumb_font' ), $css );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'product_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.product-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'product_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.product-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_title_breadcrumb_font' ), 'tablet' ) );
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.product-title .single-category' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_above_category_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_above_category_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_above_category_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.product-title .single-category' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_above_category_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_above_category_font' ), 'mobile' ) );
			...
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_title_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_title_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.woocommerce div.product .product_title' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_title_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_title_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_title_font' ), 'mobile' ) );
			$css->stop_media_query();
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.woocommerce div.product .product-single-category' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_single_category_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_single_category_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_single_category_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.woocommerce div.product .product-single-category' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_single_category_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_single_category_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_single_category_font' ), 'mobile' ) );
			$css->stop_media_query();
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'product_archive_title_height' ), 'desktop' ) );
			$css->set_selector( '.product-archive-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'product_archive_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.product-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'product_archive_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.product-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'product_archive_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.product-archive-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'product_archive_title_breadcrumb_color', 'hover' ) ) );
			$css->set_selector( '.product-archive-title .archive-description' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'product_archive_title_description_color', 'color' ) ) );
			$css->set_selector( '.product-archive-title .archive-description a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'product_archive_title_description_color', 'hover' ) ) );
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.woocommerce ul.products li.product h3, .woocommerce ul.products li.product .product-details .woocommerce-loop-product__title, .woocommerce ul.products li.product .product-details .woocommerce-loop-category__title, .wc-block-grid__products .wc-block-grid__product .wc-block-grid__product-title' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_archive_title_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_archive_title_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_archive_title_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.woocommerce ul.products li.product h3, .woocommerce ul.products li.product .product-details .woocommerce-loop-product__title, .woocommerce ul.products li.product .product-details .woocommerce-loop-category__title, .wc-block-grid__products .wc-block-grid__product .wc-block-grid__product-title' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_archive_title_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_archive_title_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_archive_title_font' ), 'mobile' ) );
			$css->stop_media_query();
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.woocommerce ul.products li.product .product-details .price, .wc-block-grid__products .wc-block-grid__product .wc-block-grid__product-price' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_archive_price_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_archive_price_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'product_archive_price_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.woocommerce ul.products li.product .product-details .price, .wc-block-grid__products .wc-block-grid__product .wc-block-grid__product-price' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'product_archive_price_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'product_archive_price_font' ), 'mobile' ) );
		...
		if ( class_exists( 'SFWD_LMS' ) ) {
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-courses_archive_title_height' ), 'desktop' ) );
			$css->set_selector( '.sfwd-courses-archive-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'sfwd-courses_archive_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.sfwd-courses-archive-hero-section .entry-hero-container-inner' );
			...
			$css->set_selector( '.sfwd-courses-archive-hero-section .entry-header' );
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-courses_archive_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.sfwd-courses-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-courses_archive_title_breadcrumb_color', 'hover' ) ) );
			$css->set_selector( '.sfwd-courses-archive-title .archive-description' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-courses_archive_title_description_color', 'color' ) ) );
			...
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-courses_title_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-courses_title_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.sfwd-courses-title h1' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-courses_title_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-courses_title_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-courses_title_font' ), 'mobile' ) );
			$css->stop_media_query();
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-courses_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.sfwd-courses-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-courses_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.sfwd-courses-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-courses_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-courses_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-courses_title_breadcrumb_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.sfwd-courses-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-courses_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-courses_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-courses_title_breadcrumb_font' ), 'mobile' ) );
			$css->stop_media_query();
			// Above Course Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-courses_title_height' ), 'desktop' ) );
			$css->set_selector( '.sfwd-courses-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'sfwd-courses_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.sfwd-courses-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-courses_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.sfwd-courses-hero-section .entry-hero-container-inner' );
			...
			$css->set_selector( '.entry-hero.sfwd-courses-hero-section .entry-header' );
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-courses_title_height' ), 'mobile' ) );
			$css->stop_media_query();
			// Course Backgrounds.
			...
			if ( class_exists( 'LearnDash_Settings_Section' ) ) {
				...
				if ( ! $in_focus_mode ) {
					...
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-lessons_title_font' ), 'tablet' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-lessons_title_font' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-lessons-title h1' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-lessons_title_font' ), 'mobile' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-lessons_title_font' ), 'mobile' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-lessons_title_font' ), 'mobile' ) );
					$css->stop_media_query();
					...
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-lessons_title_breadcrumb_color', 'color' ) ) );
					$css->set_selector( '.sfwd-lessons-title .kadence-breadcrumbs a:hover' );
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-lessons_title_breadcrumb_color', 'hover' ) ) );
					$css->start_media_query( $media_query['tablet'] );
					$css->set_selector( '.sfwd-lessons-title .kadence-breadcrumbs' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-lessons_title_breadcrumb_font' ), 'tablet' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-lessons_title_breadcrumb_font' ), 'tablet' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-lessons_title_breadcrumb_font' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-lessons-title .kadence-breadcrumbs' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-lessons_title_breadcrumb_font' ), 'mobile' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-lessons_title_breadcrumb_font' ), 'mobile' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-lessons_title_breadcrumb_font' ), 'mobile' ) );
					$css->stop_media_query();
					// Above Lesson Title.
					...
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-lessons_title_height' ), 'desktop' ) );
					$css->set_selector( '.sfwd-lessons-hero-section .hero-section-overlay' );
					$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'sfwd-lessons_title_overlay_color', 'color' ) ) );
					$css->start_media_query( $media_query['tablet'] );
					$css->set_selector( '.sfwd-lessons-hero-section .entry-hero-container-inner' );
					...
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-lessons_title_height' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-lessons-hero-section .entry-hero-container-inner' );
					...
					$css->set_selector( '.entry-hero.sfwd-lessons-hero-section .entry-header' );
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-lessons_title_height' ), 'mobile' ) );
					$css->stop_media_query();
					// Lesson Backgrounds.
					...
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-quiz_title_font' ), 'tablet' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-quiz_title_font' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-quiz-title h1' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-quiz_title_font' ), 'mobile' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-quiz_title_font' ), 'mobile' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-quiz_title_font' ), 'mobile' ) );
					$css->stop_media_query();
					...
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-quiz_title_breadcrumb_color', 'color' ) ) );
					$css->set_selector( '.sfwd-quiz-title .kadence-breadcrumbs a:hover' );
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-quiz_title_breadcrumb_color', 'hover' ) ) );
					$css->start_media_query( $media_query['tablet'] );
					$css->set_selector( '.sfwd-quiz-title .kadence-breadcrumbs' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-quiz_title_breadcrumb_font' ), 'tablet' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-quiz_title_breadcrumb_font' ), 'tablet' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-quiz_title_breadcrumb_font' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-quiz-title .kadence-breadcrumbs' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-quiz_title_breadcrumb_font' ), 'mobile' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-quiz_title_breadcrumb_font' ), 'mobile' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-quiz_title_breadcrumb_font' ), 'mobile' ) );
					$css->stop_media_query();
					// Above Quiz Title.
					...
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-quiz_title_height' ), 'desktop' ) );
					$css->set_selector( '.sfwd-quiz-hero-section .hero-section-overlay' );
					$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'sfwd-quiz_title_overlay_color', 'color' ) ) );
					$css->start_media_query( $media_query['tablet'] );
					$css->set_selector( '.sfwd-quiz-hero-section .entry-hero-container-inner' );
					...
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-quiz_title_height' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-quiz-hero-section .entry-hero-container-inner' );
					...
					$css->set_selector( '.entry-hero.sfwd-quiz-hero-section .entry-header' );
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-quiz_title_height' ), 'mobile' ) );
					$css->stop_media_query();
					// Quiz Backgrounds.
					...
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-topic_title_font' ), 'tablet' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-topic_title_font' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-topic-title h1' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-topic_title_font' ), 'mobile' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-topic_title_font' ), 'mobile' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-topic_title_font' ), 'mobile' ) );
					$css->stop_media_query();
					...
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-topic_title_breadcrumb_color', 'color' ) ) );
					$css->set_selector( '.sfwd-topic-title .kadence-breadcrumbs a:hover' );
					$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-topic_title_breadcrumb_color', 'hover' ) ) );
					$css->start_media_query( $media_query['tablet'] );
					$css->set_selector( '.sfwd-topic-title .kadence-breadcrumbs' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-topic_title_breadcrumb_font' ), 'tablet' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-topic_title_breadcrumb_font' ), 'tablet' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-topic_title_breadcrumb_font' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-topic-title .kadence-breadcrumbs' );
					$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-topic_title_breadcrumb_font' ), 'mobile' ) );
					$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-topic_title_breadcrumb_font' ), 'mobile' ) );
					$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-topic_title_breadcrumb_font' ), 'mobile' ) );
					$css->stop_media_query();
					// Above Topic Title.
					...
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-topic_title_height' ), 'desktop' ) );
					$css->set_selector( '.sfwd-topic-hero-section .hero-section-overlay' );
					$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'sfwd-topic_title_overlay_color', 'color' ) ) );
					$css->start_media_query( $media_query['tablet'] );
					$css->set_selector( '.sfwd-topic-hero-section .entry-hero-container-inner' );
					...
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-topic_title_height' ), 'tablet' ) );
					$css->stop_media_query();
					$css->start_media_query( $media_query['mobile'] );
					$css->set_selector( '.sfwd-topic-hero-section .entry-hero-container-inner' );
					...
					$css->set_selector( '.entry-hero.sfwd-topic-hero-section .entry-header' );
					$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-topic_title_height' ), 'mobile' ) );
					$css->stop_media_query();
					// Topic Backgrounds.
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'groupe_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.groupe-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'groupe_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.groupe-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'groupe_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'groupe_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'groupe_title_breadcrumb_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.groupe-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'groupe_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'groupe_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'groupe_title_breadcrumb_font' ), 'mobile' ) );
			$css->stop_media_query();
			// Above Group Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'groupe_title_height' ), 'desktop' ) );
			$css->set_selector( '.groupe-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'groupe_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.groupe-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'groupe_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.groupe-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-essays_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.sfwd-essays-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'sfwd-essays_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.sfwd-essays-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-essays_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-essays_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-essays_title_breadcrumb_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.sfwd-essays-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-essays_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-essays_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-essays_title_breadcrumb_font' ), 'mobile' ) );
			$css->stop_media_query();
			// Above Essay Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-essays_title_height' ), 'desktop' ) );
			$css->set_selector( '.sfwd-essays-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'sfwd-essays_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.sfwd-essays-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-essays_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.sfwd-essays-hero-section .entry-hero-container-inner' );
			...
			$css->set_selector( '.entry-hero.sfwd-essays-hero-section .entry-header' );
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'sfwd-essays_title_height' ), 'mobile' ) );
			$css->stop_media_query();
			...
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.ld-course-list-items .ld_course_grid.entry .course .entry-title' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-grid_title_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-grid_title_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-grid_title_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.ld-course-list-items .ld_course_grid.entry .course .entry-title' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'sfwd-grid_title_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'sfwd-grid_title_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'sfwd-grid_title_font' ), 'mobile' ) );
			$css->stop_media_query();
		}
		// Lifter CSS.
		if ( class_exists( 'LifterLMS' ) ) {
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'course_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.course-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'course_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.course-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'course_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'course_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'course_title_breadcrumb_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.course-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'course_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'course_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'course_title_breadcrumb_font' ), 'mobile' ) );
			$css->stop_media_query();
			// Above Course Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'course_title_height' ), 'desktop' ) );
			$css->set_selector( '.course-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'course_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.course-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'course_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.course-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'lesson_title_breadcrumb_color', 'color' ) ) );
			$css->set_selector( '.lesson-title .kadence-breadcrumbs a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'lesson_title_breadcrumb_color', 'hover' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.lesson-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'lesson_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'lesson_title_breadcrumb_font' ), 'tablet' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'lesson_title_breadcrumb_font' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.lesson-title .kadence-breadcrumbs' );
			$css->add_property( 'font-size', $this->render_font_size( kadence()->option( 'lesson_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'line-height', $this->render_font_height( kadence()->option( 'lesson_title_breadcrumb_font' ), 'mobile' ) );
			$css->add_property( 'letter-spacing', $this->render_font_spacing( kadence()->option( 'lesson_title_breadcrumb_font' ), 'mobile' ) );
			$css->stop_media_query();
			// Above Lesson Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'lesson_title_height' ), 'desktop' ) );
			$css->set_selector( '.lesson-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'lesson_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.lesson-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'lesson_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.lesson-hero-section .entry-hero-container-inner' );
			...
			$css->set_selector( '.entry-hero.lesson-hero-section .entry-header' );
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'lesson_title_height' ), 'mobile' ) );
			$css->stop_media_query();
			// Course Archive Title.
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'course_archive_title_height' ), 'desktop' ) );
			$css->set_selector( '.course-archive-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'course_archive_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.course-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'course_archive_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.course-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'course_archive_title_breadcrumb_color', 'hover' ) ) );
			$css->set_selector( '.course-archive-title .archive-description' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'course_archive_title_description_color', 'color' ) ) );
			$css->set_selector( '.course-archive-title .archive-description a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'course_archive_title_description_color', 'hover' ) ) );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'llms_membership_archive_title_height' ), 'desktop' ) );
			$css->set_selector( '.llms_membership-archive-hero-section .hero-section-overlay' );
			$css->add_property( 'background', $this->render_color( kadence()->sub_option( 'llms_membership_archive_title_overlay_color', 'color' ) ) );
			$css->start_media_query( $media_query['tablet'] );
			$css->set_selector( '.llms_membership-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'min-height', $this->render_range( kadence()->option( 'llms_membership_archive_title_height' ), 'tablet' ) );
			$css->stop_media_query();
			$css->start_media_query( $media_query['mobile'] );
			$css->set_selector( '.llms_membership-archive-hero-section .entry-hero-container-inner' );
			...
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'llms_membership_archive_title_breadcrumb_color', 'hover' ) ) );
			$css->set_selector( '.llms_membership-archive-title .archive-description' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'llms_membership_archive_title_description_color', 'color' ) ) );
			$css->set_selector( '.llms_membership-archive-title .archive-description a:hover' );
			$css->add_property( 'color', $this->render_color( kadence()->sub_option( 'llms_membership_archive_title_description_color', 'hover' ) ) );
		}
	...
	public function render_responsive_measure( $measure, $device, $allow_part = false ) {
		...
		if ( ! $allow_part && ! is_numeric( $measure['size'][ $device ][0] ) && ! is_numeric( $measure['size'][ $device ][0] ) && ! is_numeric( $measure['size'][ $device ][0] ) && ! is_numeric( $measure['size'][ $device ][0] ) ) {
			return false;
		}
	...
	public function action_add_gutenberg_styles() {
		wp_register_style( 'kadence-editor-global', false );
		...
		$google_fonts_url = $this->get_google_fonts_url();
		if ( ! empty( $google_fonts_url ) ) {
			wp_enqueue_style( 'kadence-google-fonts', $this->get_google_fonts_url() );
		}
	}
	/**
	...
	protected function get_css_files() : array {
		...
		$css_files = array(
			...
			'kadence-author-box'   => array(
				...
				'preload_callback' => function() {
					return is_single() && kadence()->option( 'post_author_box' );
				},
			),
