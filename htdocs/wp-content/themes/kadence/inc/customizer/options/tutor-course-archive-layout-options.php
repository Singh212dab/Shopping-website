...
$settings = array(
	'courses_archive_tabs' => array(
		'control_type' => 'kadence_tab_control',
		'section'      => 'courses_archive',
		'settings'     => false,
		'priority'     => 1,
		'input_attrs'  => array(
			'general' => array(
				'label'  => __( 'General', 'kadence' ),
				'target' => 'courses_archive',
			),
			'design' => array(
				'label'  => __( 'Design', 'kadence' ),
				'target' => 'courses_archive_design',
			),
			'active' => 'general',
		),
	),
	'courses_archive_tabs_design' => array(
		'control_type' => 'kadence_tab_control',
		'section'      => 'courses_archive_design',
		'settings'     => false,
		'priority'     => 1,
		'input_attrs'  => array(
			'general' => array(
	...
	'courses_archive_title_elements' => array(
		...
		'settings'     => array(
			...
			'description' => 'courses_archive_title_element_description',
		),
	),
	...
	'courses_archive_title_description_color' => array(
		'control_type' => 'kadence_color_control',
		'section'      => 'courses_archive_design',
		'label'        => esc_html__( 'Description Colors', 'kadence' ),
		'default'      => kadence()->default( 'courses_archive_title_description_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'courses_archive_content_style' => array(
		'control_type' => 'kadence_radio_icon_control',
		'section'      => 'courses_archive',
		'label'        => esc_html__( 'Content Style', 'kadence' ),
		'priority'     => 10,
		'default'      => kadence()->default( 'courses_archive_content_style' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.post-type-archive-courses',
				'pattern'  => 'content-style-$',
				'key'      => '',
			),
			array(
				'type'     => 'class',
				'selector' => 'body.tax-courses_cat',
				'pattern'  => 'content-style-$',
				'key'      => '',
			),
		),
	...
	'courses_archive_columns' => array(
		'control_type' => 'kadence_radio_icon_control',
		'section'      => 'courses_archive',
		'priority'     => 20,
		'label'        => esc_html__( 'Course Archive Columns', 'kadence' ),
		'transport'    => 'refresh',
		'default'      => kadence()->default( 'courses_archive_columns' ),
		'input_attrs'  => array(
			'layout' => array(
				'2' => array(
					'name' => __( '2', 'kadence' ),
