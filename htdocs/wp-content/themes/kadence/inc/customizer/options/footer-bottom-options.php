...
Theme_Customizer::add_settings(
	array(
		...
		'footer_bottom_column_spacing' => array(
			...
			'section'      => 'footer_bottom',
			'priority'     => 5,
			'label'        => esc_html__( 'Column/Widget Spacing', 'kadence' ),
			'context'      => array(
				array(
					'setting' => '__current_tab',
					'value'   => 'general',
		...
		'footer_bottom_link_colors' => array(
			...
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.site-footer .site-bottom-footer-wrap .site-footer-row-container-inner a',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'color',
				),
				array(
					'type'     => 'css',
					'selector' => '.site-footer .site-bottom-footer-wrap .site-footer-row-container-inner a:hover',
					'property' => 'color',
					'pattern'  => '$',
					'key'      => 'hover',
				),
